...
class TestOrder:
    ...
    # 获取骑行订单列表
    @pytest.mark.parametrize('caseinfo', yaml_util.read_new_yaml('/web_testcase/case/yaml_data/base_yaml/orderPlatformRideList.yaml', '/web_testcase/case/yaml_data/order/rideOrderList.yaml', '/web_testcase/case/csv_data/orderPlatformRideList.csv'))
